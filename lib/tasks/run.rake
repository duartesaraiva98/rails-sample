namespace :app do
  ...
  task :run do |_task, args|
    ...
    sh "docker run -e RAILS_MASTER_KEY=5046713e1ac7263d8abe636a56ad715a -e APP_NAME=\"rails-sample\" -e FARO_ENDPOINT=\"#{alloy_faro_endpoint}\" -e FARO_API_KEY=\"#{alloy_faro_api_key}\" --rm -p 3000:3000 --network rails rails-sample:latest"
  end
end